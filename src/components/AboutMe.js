        ...
        <div className="about-me-container">
            <div className="about-me-wrapper">
                <article className="about-me-article col1">
                    ...
                    <p  className="about-me-p">My name is Matthew L. Rodriguez. I graduated from the University of Washington in March of 2020 with a Bachelor of Science in Computer Science and Software Engineering.</p>
                </article>
